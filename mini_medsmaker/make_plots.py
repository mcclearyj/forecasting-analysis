...
def main(args):
   ...
   # Create the joined plot and axis objects
    fig1, ax_joined = plt.subplots(figsize=(8,5), tight_layout=True)
    ...
    fig2, ax_annular = plt.subplots(figsize=(8,5), tight_layout=True)
...
def plot_joined_data(fig1, ax_joined, file_path, label, color, joined_xlabel, joined_ylabel, joined_title):
    ...
    ax_joined.set_title(joined_title, fontsize=16)
